          ...
          {user ? (
            <div className="relative">
              ...
              >
                ...
                <FaChevronDown className={`text-gray-500 text-xs transition-transform duration-300 ${profileOpen ? "rotate-180" : ""}`} />
              </button>
              ...
              {profileOpen && (
                <div className="absolute top-12 right-0 w-52 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-bakery-cream/40 overflow-hidden z-50 animate-fadeIn">
                  <div className="px-4 py-3 border-b border-bakery-cream/20 bg-bakery-creamLight">
                    ...
                    <p className="text-sm font-bold text-bakery-burgundy truncate">{userName}</p>
                  </div>
                  <Link
                    to="/profile"
            ...
            {user ? (
              <div className="pt-2 space-y-3">
                <div className="flex items-center gap-3 py-2 px-1">
                  ...
                  <div>
                    <p className="text-sm font-bold text-bakery-burgundy">{userName}</p>
